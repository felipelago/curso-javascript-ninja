...
*/
const five = Number('5');//obriga a retornar a retornar o conteúdo da string como number
...
function isOperatorValid(operador){
  return !!operation[operador] //Utilizando o trufy ou false, se passar um valor diferente dos métodos +, - , *, /, % ele vai retornar undefined que é false
}
